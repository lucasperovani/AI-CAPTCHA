...
export LEVEL2_TIME_LIMIT_MS=30000       # Time limit for Level 2 in milliseconds (default: 30000)
export AI_API_KEY=your-openai-api-key   # OpenAI API key for Level 2 (optional)
...
- **LEVEL2_TIME_LIMIT_MS**: Time limit in milliseconds for Level 2 challenges (default: 30000ms/30s)
...
4. **Level 2**: If successful, system generates an AI knowledge question
   ...
   - Single-word answers in Portuguese
   - **Time limit**: Must be answered within configured time (default: 30 seconds)
...
- Pre-configured knowledge questions in Portuguese
- Single-word answers
